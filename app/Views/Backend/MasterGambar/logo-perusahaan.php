                           ...
                           <div class="card">
                              ...
                              <div class="row">
                                 <div class="col-12" style="align-items: center;">
                                    <a href="<?= base_url('/admin/edit-logo-perusahaan')?>"
                                       title="Edit Data">
                                    ...
                                    <a href="#"
                                       title="Hapus Data">
                                       <button type="button" class="btn btn-danger btn-lg btn-block"><span
...
<div class="modal fade" id="modal-logo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('/admin/simpan-logo-perusahaan') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama Perusahaan/Instansi</label>
                        <input type="text" name="nama_pt" class="form-control" placeholder="Nama Perusahaan/Instansi" required>
                    </div>
                    <div class="form-group">
